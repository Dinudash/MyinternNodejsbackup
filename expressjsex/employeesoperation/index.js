...
app.post("/saveemployee",function(req,res){
    console.log("from saveemployee services ");
  //console.log(req);
   const{ body,params,query}=req;
   console.log("body:",body);
   console.log("params:",params);
...
app.put("/updateemployeebyid/:empno",function(req,res){
...
app.delete("/deleteemployeebyid/:empno",function(req,res){
